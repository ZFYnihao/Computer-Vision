...
import scipy
import copy
from scipy import signal    # For signal.gaussian functions
...
def myEdgeFilter(img0, sigma):
    ...
    imgS=myImageFilter(img0,gausFinal,False)         ##先用myImageFilter
    ...
    imgy=myImageFilter(imgS,verSobel,True)              ##得到y，x方向上用myImageFilter过滤后的结果
