...
datadir    = 'F:/Computer Vision/assgn1/data'      # the directory containing the images          you may change to your own path here!
resultsdir = 'F:/Computer Vision/assgn1/results_sigma_3'   # the directory for dumping results   original:'F:/Computer Vision/assgn1/results'

# parameters
sigma     = 3                                    ##change here,from 2 to 3. better outcome
threshold = 0.03
rhoRes    = 2
thetaRes  = np.pi / 90
nLines    = 15                                 ##add comment: change the nLines from 15 to (5 and 20)
# end of parameters
...
for file in os.listdir(datadir):
    if file.endswith('.jpg'):
        ...
        fname = '%s/%s_04lines.png' % (resultsdir, file)                               ##Here is the final result.  We can change the parameter and get different result.
